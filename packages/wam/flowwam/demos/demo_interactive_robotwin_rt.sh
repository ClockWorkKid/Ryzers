...
#
# Real-time interactive RoboTwin demo (arms HOLD while planning; FlowWAM dual-stream flow-action policy over
...
#   ryzers run --name flowwam-robotwin /ryzers/demos/demo_interactive_robotwin_rt.sh
...
export PORT="${PORT:-8083}"                          # interactive HTTP/MJPEG port
