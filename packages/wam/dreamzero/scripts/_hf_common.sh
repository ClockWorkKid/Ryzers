...
# `hf_prefetch <repo> [files/patterns...] [--local-dir DIR] [--repo-type ...]`.
# Defaults to a single stream + Xet off for reliable anonymous downloads, and
# retries so a dropped connection resumes from cache.
