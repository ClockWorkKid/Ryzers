...
"""Environment sign-of-life for the slim AHA-WAM policy image on Strix Halo (gfx1151).
...
def main() -> int:
    ...
    # AHA-WAM package + core runtime deps.
    import ahawam                            # noqa: F401
    from ahawam.runtime import create_ahawam  # noqa: F401
    import transformers
    ...
    print("deps import ok   : ahawam, hydra, omegaconf, einops, safetensors, sentencepiece")
    print("PASS: AHA-WAM ROCm policy env OK")
    return 0
