...
def build_dataset_and_preprocessor(args):
    ...
    ds_kwargs = dict(revision=revision, episodes=episodes,
                     delta_timestamps=getattr(cfg, "delta_timestamps", None))
    if video_backend is not None:
        ds_kwargs["video_backend"] = video_backend
    ds = LeRobotDataset(repo_id, **ds_kwargs)
