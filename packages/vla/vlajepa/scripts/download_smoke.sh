...
#
# Pre-fetch ONLY what demo_smoke.sh needs into the persistent HF cache:
...
# Optional: demo_smoke.sh also downloads these on first run. Set HF_TOKEN for gated repos.
#
