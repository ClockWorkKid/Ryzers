...
"""Illustrative stub: wire a VLA-JEPA-style model into the LIBERO-Plus sim base.
...
Build + run (from the VLA-JEPA package):
    ...
    POLICY_FACTORY=vjepa_liberoplus_policy:build_policy \
      ryzers run --name vla-jepa-libero-plus /ryzers/demos/demo_interactive.sh   # http://localhost:8080
"""
import os
