...
import sim_liberoplus, is covered) and also from sim_liberoplus.__init__ for direct library use.
"""
...
def patch_torch_load():
    try:
        ...
        return
    if getattr(torch.load, "_sim_liberoplus_patched", False):
        return
    _orig = torch.load
    ...
    _load._sim_liberoplus_patched = True
    torch.load = _load
